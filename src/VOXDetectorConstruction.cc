...
VOXDetectorConstruction::~VOXDetectorConstruction()
{}

G4VPhysicalVolume* VOXDetectorConstruction::Construct()
{
    ...
    VOXNestedParameterisation* param =
            new VOXNestedParameterisation(voxelPhantom);
...
void VOXDetectorConstruction::ConstructSDandField()
{
    ...
    G4VPrimitiveScorer* scorer1 = new TETPSTrackLength("tLength", voxelPhantom);
