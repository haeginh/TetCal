...
struct Mat3 {
    ...
    double a, b, c; ///< first row
    double d, e, f; ///< second row
    double g, h ,i; ///< third row

    inline Mat3() {   }

    inline
    Mat3(double a_, double b_, double c_,
    ...
    {
        double x = v.x * a + v.y * b + v.z * c;
        double y = v.x * d + v.y * e + v.z * f;
        double z = v.x * g + v.y * h + v.z * i;
        return Vec3(x, y, z);
    }
    ...
    inline Mat3 operator*(double x) const
    {
    ...
    inline friend Mat3 operator*(const double x_, const Mat3& mat)
    {
    ...
    inline friend
    Mat2 operator/(const double x_, const Mat2& mat)
    {
    ...
    */
    ...
    inline const double& operator()(int row, int column) const
    {
        ...
        return ((double*)(this))[column + row*3];
    }
    ...
    inline Mat3 inverse() const
    {
        ...
        double c1 = f * g - d * i;
        double c2 = d * h - e * g;
        double idet = 1.f / (a * c0 + b * c1 + c * c2);
    ...
    Mat3 get_ortho() const
    {
        ...
        Mat3 h1 = h0;
        h1.set_abs();
        double eps =(1.f +  h1.min_elt()) * 1e-5f;
    ...
    double get_rotation_axis_angle(Vec3& axis) const
    {
        axis.x = h - f + 1e-5f;
        axis.y = c - g;
        axis.z = d - b;
        double sin_angle = axis.safe_normalize();
        double cos_angle = a + e + i - 1.f;
    ...
    static inline Mat3 rotate(const Vec3& axis, double angle)
    {
        Vec3 n = axis;
        n.normalize();
